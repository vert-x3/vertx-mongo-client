...
To insert documents you use `link:../../apidocs/io/vertx/ext/mongo/MongoClient.html#insertMany-java.lang.String-java.util.List-io.vertx.core.Handler-[insertMany]`.
