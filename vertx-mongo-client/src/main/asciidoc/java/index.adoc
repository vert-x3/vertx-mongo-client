...
You can run arbitrary MongoDB commands with `link:../../apidocs/io/vertx/ext/mongo/MongoClient.html#runCommand-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[runCommand]`.
