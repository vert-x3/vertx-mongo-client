...
To insert documents you use `link:groovydoc/io/vertx/groovy/ext/mongo/MongoClient.html#insertMany(java.lang.String,%20java.util.List,%20io.vertx.core.Handler)[insertMany]`.
