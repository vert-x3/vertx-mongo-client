...
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html[MongoGridFsClient]` can be used to send a whole files or buffers
...
Here's an example of getting a `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html[MongoGridFsClient]` with the default bucket
name
...
The files can be downloaded by ID using `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadFileByID-java.lang.String-java.lang.String-io.vertx.core.Handler-[downloadFileByID]` or
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadBufferById-java.lang.String-io.vertx.core.Handler-[downloadBufferById]`.
...
A list of file IDs in a bucket that match a query can be found with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#findIds-io.vertx.core.json.JsonObject-io.vertx.core.Handler-[findIds]`.
...
[source,groovy]
----
def id = "56660b074cedfd000570839c"
...
with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadFileAs-java.lang.String-java.lang.String-io.vertx.core.Handler-[downloadFileAs]`. When successful it will return an
...
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html[MongoGridFsUpload]` and `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsDownload.html[MongoGridFsDownload]`. When uploading or downloading
files using buffers, you will be provided an instance of one of these. You will then manage the stream with your own
handler.

`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html[MongoGridFsUpload]`.

If there is a buffer available to upload, call
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html#uploadBuffer-io.vertx.ext.mongo.GridFsBuffer-io.vertx.core.Handler-[uploadBuffer]`. An integer will be returned indicating
how many bytes were saved.

If there are no more data to upload call `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html#end-io.vertx.core.Handler-[end]`. The result will be an
ID generated by GridFS.
...
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsDownload.html[MongoGridFsDownload]`.

When there are data to download, read will be called.
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsDownload.html#read-java.lang.Integer-io.vertx.core.Handler-[read]`. It will provide a buffer of data as a `link:../../apidocs/io/vertx/ext/mongo/GridFsBuffer.html[GridFsBuffer]`
...
A buffer can be uploaded to GridFS with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#uploadBuffer-java.lang.String-io.vertx.core.Handler-[uploadBuffer]`. When successful it will return a
`link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html[MongoGridFsUpload]`.
...
If there is no more data to upload call `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsUpload.html#end-io.vertx.core.Handler-[end]`. The result will be an
ID generated by GridFS.
...
A buffer can be uploaded to GridFS with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#uploadBufferWithOptions-java.lang.String-io.vertx.ext.mongo.UploadOptions-io.vertx.core.Handler-[uploadBufferWithOptions]`
passing in an instance of `link:../../apidocs/io/vertx/ext/mongo/UploadOptions.html[UploadOptions]`.
...
with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadBuffer-java.lang.String-io.vertx.core.Handler-[downloadBuffer]` by providing
...
def bufferSize = 1024
def id = "56660b074cedfd000570839c"
def stream = new java.io.FileOutputStream("eel.fil")
gridFsClient.downloadBufferById(id, { res ->
  if (res.succeeded()) {
    def download = res.result()
    def downloadCompleteFuture = Future.future()
    downloadCompleteFuture.setHandler({ downloadRes ->
      if (downloadRes.succeeded()) {
        //Download finished
      } else {
        //Something went wrong
        throw new java.lang.RuntimeException(downloadRes.cause())
      }
    })
...
A file previously stored in GridFS can be downloaded to a series of buffers
with `link:../../apidocs/io/vertx/ext/mongo/MongoGridFsClient.html#downloadBufferById-java.lang.String-io.vertx.core.Handler-[downloadBufferById]` by providing
the ID of the file.
