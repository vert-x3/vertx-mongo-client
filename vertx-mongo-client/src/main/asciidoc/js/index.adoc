...
`link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html[MongoGridFsClient]` can be used to upload or download files
to GridFS.

If you prefer to interact with GridFS using streams, the `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html[MongoGridFsStreamClient]`
can be used. This will allow you to upload from any implementation of `link:../../jsdoc/module-vertx-js_read_stream-ReadStream.html[ReadStream]` and
download to any implementation of `link:../../jsdoc/module-vertx-js_write_stream-WriteStream.html[WriteStream]`.
...
Here's an example of getting a `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html[MongoGridFsClient]` with the a custom bucket
name

[source,js]
----
mongoClient.createGridFsBucketService("bakeke", function (res, res_err) {
  if (res_err == null) {
...
call `link:../../jsdoc/module-vertx-mongo-js_mongo_client-MongoClient.html#createDefaultGridFsBucketService[createDefaultGridFsBucketService]`

Here's an example of getting a `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html[MongoGridFsClient]` with the default bucket name.

[source,js]
----
mongoClient.createDefaultGridFsBucketService(function (res, res_err) {
  if (res_err == null) {
    //Interact with the GridFS client...
    var client = res;
  } else {
...
The files can be downloaded by ID using `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html#downloadFileByID[downloadFileByID]`.
...
with `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html#downloadFileAs[downloadFileAs]`.
When the download succeeds, the result handler will return the length of the download as a Long.
...
The `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html[MongoGridFsStreamClient]` is used to interact with GridFS using streams.

To retrieve this client use `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html#getGridFsStreamClient[getGridFsStreamClient]`

Here is an example of retrieving the stream client:

* [source,js]
----
var streamClient = gridFsClient.getGridFsStreamClient();

----

=== Upload a Stream to GridFS

Streams can be uploaded to GridFS using `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html#uploadByFileName[uploadByFileName]`.
Once the stream is uploaded, the result handler will be called with the ID generated by GridFS.

This has the following fields:

`stream` : the `link:../../jsdoc/module-vertx-js_read_stream-ReadStream.html[ReadStream]` to upload
...
* [source,js]
----
gridFsStreamClient.uploadByFileName(asyncFile, "kanaloa", function (stringAsyncResult, stringAsyncResult_err) {
  var id = stringAsyncResult;
});
...
Streams can be uploaded to GridFS using `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html#uploadByFileNameWithOptions[uploadByFileNameWithOptions]`
...
gridFsStreamClient.uploadByFileNameWithOptions(asyncFile, "kanaloa", options, function (stringAsyncResult, stringAsyncResult_err) {
  var id = stringAsyncResult;
});
...
Streams can be downloaded from GridFS using a file name with `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html#downloadByFileName[downloadByFileName]`.
Once the stream is downloaded a result handler will be called with the length of the stream as a Long.

This has the following fields:

`stream` : the `link:../../jsdoc/module-vertx-js_write_stream-WriteStream.html[WriteStream]` to download to
...
* [source,js]
----
gridFsStreamClient.downloadByFileName(asyncFile, "kamapuaa.fil", function (longAsyncResult, longAsyncResult_err) {
  var length = longAsyncResult;
});
...
`link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html#downloadByFileNameWithOptions[downloadByFileNameWithOptions]` passing in an instance of `link:../dataobjects.html#DownloadOptions[DownloadOptions]`.
Once the stream is downloaded a result handler will be called with the length of the stream as a Long.
...
options.revision = 0;
gridFsStreamClient.downloadByFileNameWithOptions(asyncFile, "kamapuaa.fil", options, function (longAsyncResult, longAsyncResult_err) {
  var length = longAsyncResult;
});
...
Streams can be downloaded using the ID generated by GridFS with `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_stream_client-MongoGridFsStreamClient.html#downloadById[downloadById]`.
Once the stream is downloaded a result handler will be called with the length of the stream as a Long.
...
gridFsStreamClient.downloadById(asyncFile, id, function (longAsyncResult, longAsyncResult_err) {
  var length = longAsyncResult;
});
