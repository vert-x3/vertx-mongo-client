...
`link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html[MongoGridFsClient]` can be used to send a whole files or buffers
...
A list of file IDs in a bucket that match a query can be found with `link:../../jsdoc/module-vertx-mongo-js_mongo_grid_fs_client-MongoGridFsClient.html#findIds[findIds]`.
