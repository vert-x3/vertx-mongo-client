...
To insert documents you use `link:yardoc/VertxMongo/MongoClient.html#insert_many-instance_method[insertMany]`.
...
mongoClient.insert_many("books", documents) { |res,res_err|
