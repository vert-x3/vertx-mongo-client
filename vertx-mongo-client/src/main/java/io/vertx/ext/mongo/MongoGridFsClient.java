...
public interface MongoGridFsClient {
  ...
  /**
   * Downloads a file into a buffer based on the GridFs ID.
   *
   * @param id  the GridFs Object ID of the file to download
   * @param resultHandler  called when a {@link MongoGridFsDownload} is ready that can be used to accept the buffer
   */
  @Fluent
  MongoGridFsClient downloadBufferById(String id, Handler<AsyncResult<MongoGridFsDownload>> resultHandler);
