 ...
 * {@link io.vertx.ext.mongo.MongoGridFsClient} can be used to send a whole files or buffers
 ...
 *
 * Here's an example of getting a {@link io.vertx.ext.mongo.MongoGridFsClient} with the default bucket
 * name
 *
 * [source,$lang]
 * ----
 ...
 * The files can be downloaded by ID using {@link io.vertx.ext.mongo.MongoGridFsClient#downloadFileByID} or
 * {@link io.vertx.ext.mongo.MongoGridFsClient#downloadBufferById}.
 *
 ...
 *
 * A list of file IDs in a bucket that match a query can be found with {@link io.vertx.ext.mongo.MongoGridFsClient#findIds}.
 *
 * This has the following fields:
 *
 ...
 * passing in an instance of {@link io.vertx.ext.mongo.UploadOptions}.
 *
 * This has the following parameters:
 *
 ...
 * * [source,$lang]
 * ----
 * {@link examples.Examples#example19}
 * ----
 *
 ...
 * with {@link io.vertx.ext.mongo.MongoGridFsClient#downloadFileAs}. When successful it will return an
 ...
 * {@link io.vertx.ext.mongo.MongoGridFsUpload} and {@link io.vertx.ext.mongo.MongoGridFsDownload}. When uploading or downloading
 * files using buffers, you will be provided an instance of one of these. You will then manage the stream with your own
 * handler.
 *
 * {@link io.vertx.ext.mongo.MongoGridFsUpload}.
 *
 * If there is a buffer available to upload, call
 * {@link io.vertx.ext.mongo.MongoGridFsUpload#uploadBuffer}. An integer will be returned indicating
 * how many bytes were saved.
 *
 * If there are no more data to upload call {@link io.vertx.ext.mongo.MongoGridFsUpload#end}. The result will be an
 * ID generated by GridFS.
 *
 ...
 * * [source,$lang]
 * ----
 * {@link examples.Examples#handleUploadExample}
 * ----
 *
 * {@link io.vertx.ext.mongo.MongoGridFsDownload}.
 *
 * When there are data to download, read will be called.
 * {@link io.vertx.ext.mongo.MongoGridFsDownload#read}. It will provide a buffer of data as a {@link io.vertx.ext.mongo.GridFsBuffer}
 *
 * Here is an example of a download handler:
 *
 * * [source,$lang]
 * ----
 * {@link examples.Examples#handleDownloadExample}
 * ----
 *
 * === Upload a buffer to GridFS and save with a file name
 *
 * A buffer can be uploaded to GridFS with {@link io.vertx.ext.mongo.MongoGridFsClient#uploadBuffer}. When successful it will return a
 * {@link io.vertx.ext.mongo.MongoGridFsUpload}.
 *
 * This has the following parameters:
 *
 ...
 * how many bytes were saved.
 *
 * If there is no more data to upload call {@link io.vertx.ext.mongo.MongoGridFsUpload#end}. The result will be an
 * ID generated by GridFS.
 *
 * ----
 ...
 *
 * A buffer can be uploaded to GridFS with {@link io.vertx.ext.mongo.MongoGridFsClient#uploadBufferWithOptions}
 * passing in an instance of {@link io.vertx.ext.mongo.UploadOptions}.
 *
 * This has the following fields:
 *
 ...
 * with {@link io.vertx.ext.mongo.MongoGridFsClient#downloadBuffer} by providing
 ...
 *
 * A file previously stored in GridFS can be downloaded to a series of buffers
 * with {@link io.vertx.ext.mongo.MongoGridFsClient#downloadBufferById} by providing
 * the ID of the file.
 *
 * Parameters:
