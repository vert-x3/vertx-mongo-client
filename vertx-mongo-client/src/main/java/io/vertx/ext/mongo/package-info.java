 ...
 * {@link io.vertx.ext.mongo.MongoGridFsClient} can be used to send a whole file or buffer
 ...
 * ----
 *
 * === Store a file in GridFS with options.
 *
 ...
 *
 * Here is an example of downloading a file using the name that it was stored in GridFS.
 *
 * * [source,$lang]
 * ----
 * {@link examples.Examples#example19}
 ...
 * ID generated by GridFS.
 *
 * Since binary data can not be transferred over the Event Bus using a Service Proxy, the buffer to upload
 * will have to be convertd to a Base 64 string like this:
 *
 * * [source,$lang]
 * ----
