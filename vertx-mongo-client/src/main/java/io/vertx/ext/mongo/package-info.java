 ...
 * to GridFS.
 *
 * If you prefer to interact with GridFS using streams, the {@link io.vertx.ext.mongo.MongoGridFsStreamClient}
 * can be used. This will allow you to upload from any implementation of {@link io.vertx.core.streams.ReadStream} and
 * download to any implementation of {@link io.vertx.core.streams.WriteStream}.
 *
 ...
 * [source,$lang]
 * ----
 * {@link examples.Examples#example17b}
 * ----
 *
 ...
 * passing in an instance of {@link io.vertx.ext.mongo.UploadOptions}. When it
 ...
 *
 * The {@link io.vertx.ext.mongo.MongoGridFsStreamClient} is used to interact with GridFS using streams.
 *
 * To retrieve this client use {@link io.vertx.ext.mongo.MongoGridFsClient#getGridFsStreamClient()}
 *
 ...
 *
 * Streams can be uploaded to GridFS using {@link io.vertx.ext.mongo.MongoGridFsStreamClient#uploadByFileName}.
 ...
 *
 * Streams can be uploaded to GridFS using {@link io.vertx.ext.mongo.MongoGridFsStreamClient#uploadByFileNameWithOptions}
 ...
 *
 * {@link io.vertx.ext.mongo.UploadOptions} has the following fields:
 *
 * `metadata` : this is a json object that includes any metadata that may be useful in a later search
 * `chunkSizeBytes` : GridFS will break up the file into chunks of this size
 *
 ...
 *
 * Streams can be downloaded from GridFS using a file name with {@link io.vertx.ext.mongo.MongoGridFsStreamClient#downloadByFileName}.
 ...
 * {@link io.vertx.ext.mongo.MongoGridFsStreamClient#downloadByFileNameWithOptions} passing in an instance of {@link io.vertx.ext.mongo.DownloadOptions}.
 * Once the stream is downloaded a result handler will be called with the length of the stream as a Long.
 *
 * This has the following fields:
 *
 * `stream` : the {@link io.vertx.core.streams.WriteStream} to download to
 * `fileName` : the name of the file that will be downloaded to the stream
 * `options` : an instance of {@link io.vertx.ext.mongo.DownloadOptions}
 *
 ...
 *
 * Streams can be downloaded using the ID generated by GridFS with {@link io.vertx.ext.mongo.MongoGridFsStreamClient#downloadById}.
 * Once the stream is downloaded a result handler will be called with the length of the stream as a Long.
 *
 * This has the following fields:
 *
