      ...
      switch (member.getKey()) {
        ...
        case "caseFirst":
          if (member.getValue() instanceof String) {
            obj.setCaseFirst(io.vertx.ext.mongo.CollationOptions.CaseFirst.valueOf((String)member.getValue()));
          }
          break;
        case "caseLevel":
          if (member.getValue() instanceof Boolean) {
        ...
        case "maxVariable":
          if (member.getValue() instanceof String) {
            obj.setMaxVariable(io.vertx.ext.mongo.CollationOptions.MaxVariable.valueOf((String)member.getValue()));
          }
          break;
        case "normalization":
          if (member.getValue() instanceof Boolean) {
