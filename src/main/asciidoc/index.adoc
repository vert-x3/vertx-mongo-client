...
`trustAll`:: When using ssl, trust _ALL_ certificates. *WARNING* - Trusing _ALL_ certificates will open you up to potential security issues such as MITM attacks.
