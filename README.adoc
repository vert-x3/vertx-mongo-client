...
Please see the in source asciidoc link:vertx-mongo-client/src/main/asciidoc/java/index.adoc[documentation] or the main documentation on the http://vertx.io/docs/#data_access[web-site] for a full description
of Mongo service.
